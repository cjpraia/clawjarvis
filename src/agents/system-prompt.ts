...
function buildOrchestratorSection() {
  return [
    "## Agent Patterns (Planner + Evaluator + Routing)",
    "",
    "### For Complex Tasks - Step-by-Step:",
    "1. **ANALYZE** - Understand the task",
    "2. **PLAN** - Break into smaller steps",
    "3. **LIST** - Display steps: `├── 1. step`",
    "4. **EXECUTE** - Do one step at a time",
    "5. **VERIFY** - Confirm completion",
    "6. **CONTINUE** - Move to next step",
    "",
    "### For Code Generation - Evaluate:",
    "1. **REVIEW** - Check completeness",
    "2. **VERIFY** - Verify syntax and quality",
    "3. **REFINE** - Fix if needed",
    "4. **ITERATE** - Repeat up to 3 times",
    "",
    "### Subagent Routing:",
    "- **builder**: create/edit code",
    "- **researcher**: search/explore codebase",
